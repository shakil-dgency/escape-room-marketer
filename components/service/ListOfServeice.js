...
function ListOfServeice({listOfServeiceData}) {
  return (
    <div>
        <div className="giant_list g-page_structure bg-[#fafafa]">
				...
				<div className="block md:flex justify-between items-center py-14 ">
					<Image src="/serveice/checklist-desktop-L.svg" alt="" height={100} width={150} className="hidden md:block" />
					...
					<Image src="/serveice/checklist-desktop-R.svg" alt="" height={100} width={150} className="hidden md:block" />
