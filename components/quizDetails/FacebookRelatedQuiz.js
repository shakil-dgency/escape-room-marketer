...
function FacebookRelatedQuiz() {
  return (
    ...
    <div className="bg-[#F9FCFF] flex">
        <Image src="/resources/quiz_details/facebook_quiz/facebook_left.svg" alt="" height={100} width={100} className="flex-1 opacity-40" />
        ...
        <Image src="/resources/quiz_details/facebook_quiz/facebook_right.svg" alt="" height={100} width={100} className="flex-1 opacity-40" />
    </div>
</div>
  )
}
