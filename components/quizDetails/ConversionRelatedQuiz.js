	...
	return (
		<div>
			...
			<div className="bg-[#F9FCFF] flex">
				<Image src="/resources/quiz_details/conversion_quiz/conversion_left.svg" alt="" height={100} width={100} className="flex-1 opacity-40" />
				...
				<Image src="/resources/quiz_details/conversion_quiz/conversion_right.svg" alt="" height={100} width={100} className="flex-1 opacity-40" />
			</div>
		</div>
	);
}
